...
func FuzzDetectImageFormat(f *testing.F) {
	...
	f.Add([]byte{0x47, 0x49, 0x46, 0x38})
	f.Add([]byte{0x52, 0x49, 0x46, 0x46, 0x00, 0x00, 0x00, 0x00, 0x57, 0x45, 0x42, 0x50})
	f.Add([]byte{0x42, 0x4D, 0x36, 0x00})
	f.Add([]byte{0x52, 0x49, 0x46, 0x46, 0x00, 0x00, 0x00, 0x00, 0x57, 0x41, 0x56, 0x45})
	f.Add([]byte{})

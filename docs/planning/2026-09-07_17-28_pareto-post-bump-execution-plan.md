...
> dropped: the main CHANGELOG already tracks submodule releases); M17 resolved
> by probe (nixpkgs ships 1.26.7, already pinned by `2934585`); M21 docs+probe
> done, activation itself user-gated; M19/M20/M22 prepared as user-decision
> proposals (see TODO_LIST); **M9 remains open — user-gated on release-cadence
